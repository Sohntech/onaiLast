...
class ArticleController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->sendResponse($articles, StateEnum::SUCCESS, 'Articles affichés avec succès');
    }
    ...
    public function show($id)
    {
        ...
        return $this->sendResponse($article, StateEnum::SUCCESS, 'Article affiché avec succès');
    }
    ...
    public function update(UpdateArticleRequest $request, Article $article)
    {
        ...
        if (empty($validatedData)) {
            return $this->sendResponse(null, StateEnum::ECHEC, 'Au moins un article est requis pour la mise à jour', 422);
        }
        ...
        return $this->sendResponse($article, StateEnum::SUCCESS, 'Stock de l\'article mis à jour avec succès');
    }
    ...
    public function destroy(Article $article)
    {
        ...
        $article->delete();
        return $this->sendResponse($article, StateEnum::SUCCESS, 'Article mis à la corbeille avec succès');
    }
    ...
    public function trashed()
    {
        ...
        return $this->sendResponse($trashedArticles, StateEnum::SUCCESS, 'Articles à la corbeille affichés avec succès');
    }
